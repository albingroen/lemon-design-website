                ...
                <Stack direction="vertical" spacing="large">
                  <Stack direction="vertical">
                    ...
                    <Typography.Paragraph dim>
                      ...
                      components. We do this in order to prevent duplicate
  ...
  "./node_modules/lemon-design-react/src/**/*.tsx"
                ...
                <Stack direction="vertical" spacing="large">
                  <Stack direction="vertical">
                    ...
                    <Typography.Paragraph dim>
                      ...
                      <code>AvatarGroup</code> and <code>Sidebar</code>, you
                      need to import this style sheet in the root of your
                      project.
                    </Typography.Paragraph>
                  </Stack>
                  <code className="code">
                ...
                <Stack direction="vertical" spacing="large">
                  <Stack direction="vertical">
                    ...
                    <Divider />
                    <Typography.Paragraph dim>
                      One last thing you will have to do to get the proper
                      styles for the components is to install the{" "}
